...
#define LEDPIN 12
char tag[] ="3C0087D597F9"; // Replace with your own Tag ID
...
void loop()
{
if(mySerial.available())// Check if there is incoming data in the RFID Reader SerialBuffer.
{
...
flag = 1; // everytime the values match, we set the flag variableto 1
else
flag= 0;
